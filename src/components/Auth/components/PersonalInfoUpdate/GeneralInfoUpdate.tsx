...
import { User, Globe, Phone, FileText, Info, Loader2 } from "lucide-react";
...
export function GeneralInfoUpdate() {
  ...
  const form = useForm<z.infer<typeof updateUserProfileSchema>>({
    ...
    defaultValues: {
      ...
      organization_name: organizationData?.user_name || "",
    },
  });
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="flex items-center gap-2 mb-2 text-sm text-gray-600">
                      ...
                      <span>
                        Tell us about your background, interests, and expertise
                      </span>
                    </div>
                    <FormControl>
                      <Textarea
