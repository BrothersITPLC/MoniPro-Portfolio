        ...
        <CardContent>
          <div className="grid gap-6">
            <div className="flex flex-col gap-4">
              <Button
                variant="outline"
                className="w-full border border-red-600 dark:border-gray-700 hover:bg-red-50 dark:hover:bg-red-900/30 transition-all duration-300"
                type="button"
              >
                <svg
            ...
            <div className="flex items-center justify-center space-x-2 mb-4">
              <span
                className={`text-sm ${
                  !isPrivate ? "text-red-500 font-medium" : "text-gray-500"
                }`}
              >
                Company
              </span>
