  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      if (currentStep === 3) {
        ...
        const finalSubmission = { ...values, selectedPlan, selectedPaymentMethod };
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 2:
        return (
          <div>
            <Pricing onSubscriptionSelect={handleNext} setSelectedPlan={setSelectedPlan} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <button
                   ...
                   className={`p-6 border rounded-lg transition-all ${
                     selectedPaymentMethod === "TelleBirr" ? "border-red-500" : "hover:border-red-500"
                   }`}
                 >
                 ...
                 <button
                   ...
                   className={`p-6 border rounded-lg transition-all ${
                     selectedPaymentMethod === "Chapa" ? "border-red-500" : "hover:border-red-500"
                   }`}
                 >
